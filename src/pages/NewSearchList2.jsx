...
export default function NewSearchList2() {
  return (
    <>
      ...
      <Link className="aon-vender-pic-link" to="/profile-full"/>
      </div>
      <div className="aon-vender-list-info">
      <h4 className="aon-venders-title"><Link to="/profile-full"/>Mila Kunis</h4>
      ...
      <Link className="aon-req-btn-posi" to="/profile-full"/>Request A Quote
      </div>
      </div>
      </div>
      </div>
      ...
      <div className="aon-vender-list-info">
      <h4 className="aon-venders-title"><Link to="/profile-full"/>Javier Bardem</h4>
      <span className="aon-venders-address"><i className="fa fa-map-marker"></i>Queens, United States</span>
      <div className="aon-ow-pro-rating">
      <span className="fa fa-star"></span>
      <span className="fa fa-star"></span>
      ...
      <div className="aon-vender-list-info">
      <h4 className="aon-venders-title"><Link to="/profile-full"/>Edward Luise</h4>
      <span className="aon-venders-address"><i className="fa fa-map-marker"></i>Queens, United States</span>
      <div className="aon-ow-pro-rating">
      <span className="fa fa-star"></span>
      <span className="fa fa-star"></span>
      ...
      <div className="aon-vender-list-info">
      <h4 className="aon-venders-title"><Link to="/profile-full"/>James McAvoy</h4>
      <span className="aon-venders-address"><i className="fa fa-map-marker"></i>Queens, United States</span>
      <div className="aon-ow-pro-rating">
      <span className="fa fa-star"></span>
      <span className="fa fa-star"></span>
      ...
      <div className="aon-vender-list-info">
      <h4 className="aon-venders-title"><Link to="/profile-full"/>Jackie Chan</h4>
      <span className="aon-venders-address"><i className="fa fa-map-marker"></i>Queens, United States</span>
      <div className="aon-ow-pro-rating">
      <span className="fa fa-star"></span>
      <span className="fa fa-star"></span>
      ...
      <div className="aon-vender-list-wrap3">
      <div className="aon-vender-list-box3 d-flex">
      <div className="aon-vender-list-pic" style={{backgroundImage: "url(/images/vender-list/6.jpg)"}}>
      <Link className="aon-vender-pic-link" to="/profile-full"/>
      </div>
      <div className="aon-vender-list-info">
      <h4 className="aon-venders-title"><Link to="/profile-full"/>Colin Farrell</h4>
      <span className="aon-venders-address"><i className="fa fa-map-marker"></i>Queens, United States</span>
      <div className="aon-ow-pro-rating">
      <span className="fa fa-star"></span>
      <span className="fa fa-star"></span>
