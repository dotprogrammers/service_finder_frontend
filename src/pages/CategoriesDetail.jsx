...
export default function CategoriesDetail() {
  return (
    <>
      ...
      <span className="sf-caty-num"></span>
      <a className="sf-caty-link" href="#"></a>
      </div>
      <h5 className="sf-catyitem-title"><Link to="/categories-detail"/>Car Mechanics</h5>
      </div>
      <div className="sf-catyitem-box">
      ...
      <h5 className="sf-catyitem-title"><Link to="/categories-detail"/>House Cleaning</h5>
      </div>
      </div>
      ...
      <h5 className="sf-catyitem-title"><Link to="/categories-detail"/>Kitchen Cleaning</h5>
      </div>
      <div className="sf-catyitem-box">
      ...
      <h5 className="sf-catyitem-title"><Link to="/categories-detail"/>Cafe</h5>
      </div>
      </div>
      ...
      <h5 className="sf-catyitem-title"><Link to="/categories-detail"/>Plumber</h5>
      </div>
      <div className="sf-catyitem-box">
      ...
      <h5 className="sf-catyitem-title"><Link to="/categories-detail"/>Fitness</h5>
      </div>
      </div>
      ...
      <h5 className="sf-catyitem-title"><Link to="/categories-detail"/>Hair Salon</h5>
      </div>
      <div className="sf-catyitem-box">
      ...
      <h5 className="sf-catyitem-title"><Link to="/categories-detail"/>Gym</h5>
      </div>
      </div>
      ...
      <h5 className="sf-catyitem-title"><Link to="/categories-detail"/>Gardening</h5>
      </div>
      <div className="sf-catyitem-box">
      ...
      <h5 className="sf-catyitem-title"><Link to="/categories-detail"/>Electrician</h5>
      </div>
      </div>
      </div>
      </div>
