                ...
                <div className="row">
                  <div className="col-lg-4 col-md-6">
                    <div className="sf-contact-info-box">
                      <div className="sf-contact-icon">
                        <span>
                          <img alt="" src="/images/contact-us/1.png" />
                        </span>
                      </div>
                  ...
                  <div className="col-lg-4 col-md-6">
                    <div className="sf-contact-info-box">
                      <div className="sf-contact-icon">
                        <span>
                          <img alt="" src="/images/contact-us/2.png" />
                        </span>
                      </div>
                      <div className="sf-contact-info">
                  ...
                  <div className="col-lg-4 col-md-6">
                    <div className="sf-contact-info-box">
                      <div className="sf-contact-icon">
                        <span>
                          <img alt="" src="/images/contact-us/3.png" />
                        </span>
                      </div>
                      <div className="sf-contact-info">
                    ...
                    <div className="row">
                      ...
                      <div className="col-md-12">
                        <div
                          ...
                          data-sitekey="6LeBsyIeAAAAAFfgca0q_h1Dxoy8ekbilrjdBlMf"
                        ></div>
                      </div>
                    </div>
          ...
          <div className="container">
            <div className="sf-map-social-block text-center">
              ...
              <ul className="sf-con-social">
                <li>
                  <a to="#" className="sf-fb ">
                    <button className="flex gap-1 justify-center items-center text-white">
                      <Facebook /> Facebook
                    </button>
                  </a>
                </li>
                ...
                <li>
                  <a className="sf-pinterest" href="#">
                    <button className="flex gap-1 justify-center items-center text-white">
                      <img alt="" src="/images/contact-us/pinterest.png" />
                      Pinterest
                    </button>
                  </a>
                </li>
              ...
              <div className="sf-con-social-pic">
                <span className="img-pos-1">
                  <img alt="" src="/images/contact-us/img1.png" />
                </span>
                <span className="img-pos-2">
                  <img alt="" src="/images/contact-us/img2.png" />
                </span>
                <span className="img-pos-3">
                  <img alt="" src="/images/contact-us/img3.png" />
                </span>
                <span className="img-pos-4">
                  <img alt="" src="/images/contact-us/r-img1.png" />
                </span>
                <span className="img-pos-5">
                  <img alt="" src="/images/contact-us/r-img2.png" />
                </span>
                <span className="img-pos-6">
                  <img alt="" src="/images/contact-us/r-img3.png" />
                </span>
              </div>
            </div>
          </div>
