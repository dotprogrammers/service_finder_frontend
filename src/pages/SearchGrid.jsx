...
export default function SearchGrid() {
  return (
    <>
      ...
      <div className="aon-ow-mid">
      <div className="aon-ow-media">
      <Link to="/profile-full"/><img alt="" src="/images/providers/7.jpg"/>
      </div>
      <p>Through our expertise, technological knowledge, global presence and bespoke.</p>
      <div className="aon-ow-pro-rating">
      <span className="fa fa-star"></span>
      ...
      <div className="aon-ow-mid">
      <div className="aon-ow-media">
      <Link to="/profile-full"/><img alt="" src="/images/providers/8.jpg"/>
      </div>
      <p>Through our expertise, technological knowledge, global presence and bespoke.</p>
      <div className="aon-ow-pro-rating">
      <span className="fa fa-star"></span>
      ...
      <div className="aon-ow-mid">
      <div className="aon-ow-media">
      <Link to="/profile-full"/><img alt="" src="/images/providers/9.jpg"/>
      </div>
      <p>Through our expertise, technological knowledge, global presence and bespoke.</p>
      <div className="aon-ow-pro-rating">
      <span className="fa fa-star"></span>
