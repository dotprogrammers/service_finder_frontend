  ...
  points: [
    {
      ...
      desc: "All our service providers are thoroughly vetted and verified. We check credentials, licenses, and insurance to ensure you're working with qualified professionals.",
    },
    {
      id: 2,
      icon: <BarChartOutlined className="text-[22px] text-amber-500" />,
      title: "Competitive Pricing",
      desc: "Our bidding system ensures you get competitive quotes. Compare multiple offers and choose the best price-to-quality ratio that fits your budget.",
    },
    {
      id: 3,
      icon: <StarOutlined className="text-[22px] text-amber-500" />,
      title: "Trusted Reviews & Ratings",
      desc: "Make informed decisions based on real customer reviews and ratings. Our transparent feedback system helps you choose providers with proven track records.",
    },
    {
      id: 4,
      icon: <ThunderboltOutlined className="text-[22px] text-amber-500" />,
      title: "Simple & Fast Process",
      desc: "Post your project in minutes, receive bids within hours, and hire the perfect provider in days. Our streamlined process saves you time and effort.",
    },
  ],
  ctas: [
...
export default function WhyChooseSection({ data = whyChooseData, imageUrl }) {
  return (
                ...
                <ul className="aon-why-choose-steps list-unstyled">
                  <li className="d-flex">
                    <div className="aon-w-choose-left aon-icon-effect">
                      <div className="aon-w-choose-icon flex justify-center items-center">
